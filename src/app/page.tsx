      ...
      <nav className="fixed top-0 w-full z-50 glass px-8 py-6 flex justify-between items-center">
        <div className="flex items-center space-x-12">
          ...
          <div className="hidden lg:flex items-center space-x-8">
            ...
            <Link href="/stays" className="text-[10px] tracking-widest text-white/50 hover:text-white transition-all uppercase">Stays</Link>
            <Link href="/travel" className="text-[10px] tracking-widest text-white/50 hover:text-white transition-all uppercase">Travel</Link>
